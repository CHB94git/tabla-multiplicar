...
EJEMPLO DE USO: node app -b 5 ("Genera la tabla solicitada (Carpeta tablasGeneradas),
                                pero no la muestra en consola)
    node app -b 7 -m ("Muestra la tabla del 7, hasta 7x10")
        NOTA: -m --> De esta manera indicamos que queremos ver el resultado en consola
    node app -b 10 -l 20 ("Muestra la tabla del 10, hasta 10x20")
        -l 20 ("Modifica el valor por defecto(10) y genera la tabla hasta un límite dado")
```
